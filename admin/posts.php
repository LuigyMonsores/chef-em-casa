                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="edit_post.php?post_id=<?php
                                            echo $post['id'] ?>">
                                                <i class="fas fa-edit"></i>
                                                Editar
                                            </a>
                                            <a class="dropdown-item text-danger" href="#"
                                            onclick="confirm('Você realmente deseja apagar essa publicação?') ? window.location.href='request/request_delete_post.php?post_id=<?php echo $post['id']; ?> ' : ''">
